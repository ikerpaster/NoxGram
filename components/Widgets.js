...
function Widgets() {
  ...
  return (
    <div className="hidden lg:inline ml-8 xl:w-[450px] py-1 space-y-5 ">
      ...
      <div
        className="text-[#d9d9d9] space-y-3 bg-[#15181c] pt-2 rounded-xl w-11/12 xl:w-9/12 sticky top-1 max-h-screen
        overflow-y-scroll scrollbar-thumb-blue-700 scrollbar-track-gray-100 scrollbar-thin"
      >
